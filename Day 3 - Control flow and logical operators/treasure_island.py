...
while True:
    cross_road_decision = input(
        "You're at a cross road. Where do you want to go? Type \"left\" or \"right\" \n")

    if cross_road_decision.lower() == "left":
        wait_or_swim = input(
            "You've come to a lake. There is an isaland in the middle of the lake. Type \"wait\" to wait for a boat. Type \"swim\" to swim across.\n")
